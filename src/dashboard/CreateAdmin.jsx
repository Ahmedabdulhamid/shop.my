...
import { createAdminUsers } from '../REDUXTOOLKIT/Operation';
...
export const CreateAdmin = () => {
    ...
    const [genderL, setGenderL] = useState(false);
    const onSubmit = (data) => {

        console.log(data);
        dispatch(createAdminUsers(data))
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12 ">
                                    <Card className="width-100 bg-none" style={{ border: "none" }}>
                                        ...
                                        <TextField id="outlined-basic" type={showPassword ? 'text' : 'password'} label="Password" variant="outlined" className='my-3 mx-3'
                                            ...
                                            helperText={Boolean(errors.password) ? "Required password" : null}
